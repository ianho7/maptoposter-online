...
export interface InitOutput {
    ...
    readonly hello_wasm: (a: number, b: number) => [number, number];
    readonly init_panic_hook: () => void;
    readonly parse_polygons_to_bin: (a: number, b: number) => [number, number, number];
    readonly parse_polygons_typed: (a: number, b: number) => [number, number, number];
    readonly parse_polygons_val: (a: any) => [number, number, number];
    readonly parse_roads_to_bin: (a: number, b: number) => [number, number, number];
    readonly parse_roads_typed: (a: number, b: number) => [number, number, number];
    readonly parse_roads_val: (a: any) => [number, number, number];
    readonly process_polygons_bin_wasm: (a: number, b: number) => [number, number, number];
    readonly process_roads_bin_wasm: (a: number, b: number) => [number, number, number];
    readonly render_map: (a: number, b: number) => number;
    readonly render_map_binary: (a: any, b: number, c: number, d: number, e: number, f: number, g: number) => number;
    readonly render_map_binary_with_font: (a: any, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
    readonly render_map_msgpack: (a: number, b: number) => number;
    readonly renderresult_error: (a: number, b: number) => number;
    readonly renderresult_get_data: (a: number) => [number, number];
    readonly renderresult_get_error: (a: number) => [number, number];
